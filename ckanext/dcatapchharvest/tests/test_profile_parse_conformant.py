...
class ConformantProfileParseTest(unittest.TestCase):
    ...
    def test_mapping_of_datasets(self):
        """"test the pick up of all datasets specified in dcat:dataset"""
        eq_(len(self.datasets), 2)

    def test_mapping_of_landing_page(self):
        """"test the pick up of all landing page when given as uri"""
        eq_(self.dataset['url'], u"https://www.bfs.admin.ch/bfs/de/home/statistiken.html")

    def test_mapping_of_publisher(self):
    ...
    def test_mapping_of_date_before_1900(self):
    ...
    def test_mapping_of_issued_as_xsd_datetime(self):
        ...
        eq_(modified.date().isoformat(), u'2017-04-24')

    def test_mapping_of_modified_as_xsd_datetime(self):
        """test the pick up of issued as string typed as xsd:datetime"""
    ...
    def test_mapping_of_keywords(self):
